...
Without this visibility, strategic planning, budgeting, and resource allocation were largely based on intuition rather than data.

---

## 🔧 Approach

Built an end-to-end Excel BI report covering both Sales and Finance dimensions, structured into 11 focused sub-reports:
...
| Top 5 Revenue-Generating Countries | Geographical concentration of revenue |

### Finance Analysis
| Report | Purpose |
|---|---|
| Annual P&L Report | Yearly revenue, cost, and margin summary |
| Monthly P&L Comparison | Trend and seasonality analysis across months |
| Market-Specific P&L | Regional profitability breakdown |
| Quarterly GM% by Region | Sub-region margin health over time |
